...
- **Os dados podem ser apagados se o serviço reiniciar** enquanto está
  dormindo (o banco SQLite fica no disco temporário do plano free).
  Para um evento de um dia, o risco é baixo se o uso for contínuo, mas para
  eliminar esse risco: use um serviço gratuito como o
  **UptimeRobot** (`uptimerobot.com`, grátis) para "pingar" seu link a cada
  5 minutos durante o evento — isso mantém o serviço sempre acordado e
  evita reinícios inesperados.
